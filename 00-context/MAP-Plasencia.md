...
| Discovery Gerentes MKT — Brief abierto (formato libre, 8 dimensiones temáticas) — ESTE SE MANDA AL GERENTE | `01-strategy/Discovery-Gerentes-MKT-Brief.html` (paper A4, sistema de diseño corporativo Navy+Red+Gold, Playfair+Inter, 5 páginas) · versión markdown editable: `01-strategy/Discovery-Gerentes-MKT-Brief.md` | `01-strategy/Discovery-Gerentes-MKT-Cuestionario.md` (checklist interno del Director, NO se manda) |
