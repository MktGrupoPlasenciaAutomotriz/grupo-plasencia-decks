...
| Seminuevos — Capítulo marca-negocio del piloto Motor de Atribución MVP (Strategy Paper con concepto rector "Sin Sorpresas" como governing thought del capítulo; **NO es estrategia anual maestra**, ES el capítulo marca-negocio del piloto aplicado a Seminuevos como caso canónico; el piloto está LIVE desde 16-abr-2026, Seminuevos concentra ~70% del volumen; rige comunicación externa, experiencia digital, operación comercial y capítulos tácticos derivados —Meta Ads, futuros—; **informativo · "marketing al marketing"** para directores y gerentes de marca involucrados, **no requiere aprobación**; la campaña sube cuando termina la producción; **métrica operativa central = adopción del modelo lite por los vendedores** —operación estructurada y tecnificada del pipeline, a la que no están acostumbrados—; si el piloto funciona, se evalúa cómo escalar a Hyundai, Stellantis y marcas-OEM bajo Experiencia Plasencia Automotriz) | `01-strategy/Seminuevos-Concepto-Rector-Sin-Sorpresas.md` (markdown source of truth) + `01-strategy/Seminuevos-Sin-Sorpresas-Paper-Ejecutivo.html` (Strategy Paper A4, sistema visual Navy + Red + Gold Seminuevos, Playfair + Inter, estructura Minto + SCR + Answer-First, para Pepe Morales / Jonathan Medina / Jose Reyes / Gerentes de Marca) | `01-strategy/Motor-Atribucion-Consejo-Strategy-Definition.md` + `01-strategy/Motor-Atribucion-Consejo-Paper-Ejecutivo.html` (Strategy Definition del piloto completo, marco superior inmediato), `01-strategy/Experiencia-Plasencia-Automotriz-Framing.md` (marco post-piloto si escala), `01-strategy/El-Patron-Que-Gano-Experiencia-Plasencia.html` (evidencia global), `01-strategy/Seminuevos-Estrategia-Andromeda-v4-Working.md` (capítulo táctico Meta Ads, pendiente incorporación al paper), `00-context/KO-Estrategico.md` (datos cuantitativos sostén) |
