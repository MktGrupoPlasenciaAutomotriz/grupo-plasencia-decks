...
| Seminuevos — Estrategia de Marca-Negocio 2026–2027 (Strategy Definition con concepto rector "Sin Sorpresas" como governing thought; capítulo táctico de Experiencia Plasencia Automotriz; rige comunicación externa, experiencia digital, operación comercial y capítulos tácticos derivados —Meta Ads, futuros—; **informativo · "marketing al marketing"** para directores y gerentes de marca involucrados, **no requiere aprobación**; la campaña sube cuando termina la producción; es piloto que se prueba y mide; **métrica operativa central = adopción del modelo lite por los vendedores** (operación estructurada y tecnificada del pipeline, a la que no están acostumbrados); comunicación corporativa al Consejo es condicional en Fase 4) | `01-strategy/Seminuevos-Concepto-Rector-Sin-Sorpresas.md` (markdown source of truth) + `01-strategy/Seminuevos-Sin-Sorpresas-Paper-Ejecutivo.html` (paper A4 ejecutivo, sistema visual Navy + Red + Gold Seminuevos, Playfair + Inter, estructura Minto + SCR + Answer-First, para Pepe Morales / Jonathan Medina / Jose Reyes / Gerentes de Marca) | `01-strategy/Experiencia-Plasencia-Automotriz-Framing.md` (marco superior), `01-strategy/El-Patron-Que-Gano-Experiencia-Plasencia.html` (evidencia global), `01-strategy/Seminuevos-Estrategia-Andromeda-v4-Working.md` (capítulo táctico Meta Ads, pendiente incorporación al paper), `00-context/KO-Estrategico.md` (datos cuantitativos sostén) |
