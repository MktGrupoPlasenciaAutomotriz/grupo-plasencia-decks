...
| Seminuevos — Concepto rector "Sin Sorpresas" (source of truth de la marca-negocio Seminuevos; capítulo táctico de Experiencia Plasencia Automotriz; rige comunicación, experiencia digital, operación de vendedores y pitch institucional) | `01-strategy/Seminuevos-Concepto-Rector-Sin-Sorpresas.md` (doc estratégico ejecutable, markdown) + `01-strategy/Seminuevos-Sin-Sorpresas-Paper-Ejecutivo.html` (paper A4 12 páginas, sistema de diseño corporativo Navy + Gold Seminuevos + Red, Playfair + Inter, estructura Minto + SCR + Answer-First, para Pepe Morales / Jonathan Medina / Consejo) | `01-strategy/Experiencia-Plasencia-Automotriz-Framing.md` (marco superior), `01-strategy/El-Patron-Que-Gano-Experiencia-Plasencia.html` (evidencia global), `01-strategy/Always-On-Seminuevos-Concepto.md` (concepto Meta Ads previo a iterar v4), `00-context/KO-Estrategico.md` (datos cuantitativos sostén) |
